...
{{--    <meta name="csrf-token" content="{{ csrf_token() }}">--}}
    ...
    <!-- Estilo General -->
    <link href="{{ asset('css/admin/css/estilo.css') }}" rel="stylesheet">

    <!-- Jquery Core Js -->
    <script src="{{ asset('css/admin/plugins/jquery/jquery.min.js') }}" ></script>
    <!-- Bootstrap Core Js -->
    <script src="{{ asset('css/admin/plugins/bootstrap/js/bootstrap.js') }}" defer></script>
    <!-- Select Plugin Js -->
    <script src="{{ asset('css/admin/plugins/bootstrap-select/js/bootstrap-select.js') }}" defer></script>
    <!-- Slimscroll Plugin Js -->
    <script src="{{ asset('css/admin/plugins/jquery-slimscroll/jquery.slimscroll.js') }}" ></script>
    <!-- Waves Effect Plugin Js -->
    <script src="{{ asset('css/admin/plugins/node-waves/waves.js') }}" defer></script>
    <!-- Jquery Validation Plugin Css -->
    <script src="{{ asset('css/admin/plugins/jquery-validation/jquery.validate.js') }}" defer></script>
    <!-- JQuery Steps Plugin Js -->
    <script src="{{ asset('css/admin/plugins/jquery-steps/jquery.steps.js') }}" defer></script>
    <!-- Custom Js -->
...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="../../index.html">ADMINISTRADOR PARA MUESTRA DE TABLA</a>
        </div>
...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            <div class="image">
                <img src="{{ asset('css/admin/images/user.png') }}" width="48" height="48" alt="User" />
            </div>
