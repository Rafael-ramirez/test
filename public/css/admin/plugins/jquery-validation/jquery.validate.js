...
$.extend( $.validator, {
	...
	messages: {
        ...
        equalTo: "Por favor, ingrese la misma información nuevamente.",
        ...
        max: $.validator.format( "Por favor, ingrese un valor que sea menor o igual a {0}." ),
        min: $.validator.format( "Por favor, ingrese un valor que sea mayor o igual a {0}." ),
